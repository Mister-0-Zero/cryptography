...
if __name__ == "__main__":
    text = "онукя щнсгт мьоля хлкйм цбйьс нфуйэ фэжиг тоойб"
            "ОНУКЯЩНСГТМЪОЛЯХЛКЙМЦБЙЬСНФЧЙЭФЭЖИГТООЙБ"
    ...
    # print()
    print(decrypt_vigener_self_key("ОНУКЯЩНСГТМЪОЛЯХЛКЙМЦБЙЬСНФЧЙЭФЭЖИГТООЙБ", "Б"))